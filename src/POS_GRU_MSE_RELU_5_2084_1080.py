...
window_size = 5 #WINDOW_SIZE # 3, 4, 5
accuracy_threshold = 0.85
activation = 'relu' #ACTIVATION_FUNCTION # sigmoid, relu, softmax
custom_accuracy = 0
loss_function = 'mse' #LOSS_FUNCTION # mse

model_name = 'POS_GRU ' + ' 2084_1080 ' + loss_function + "_"+ str(custom_accuracy) + "_" + activation + "_" + str(window_size) + "_" + str(batch_size)
...
model = Sequential()
model.add(GRU(2084, input_shape=(x_data.shape[1], x_data.shape[2]), return_sequences=True))
