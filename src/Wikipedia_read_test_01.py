...
def to_json(list_of_titles):
    """ Convert list of dictionary into a json file and save it into wiki_text.json file. """
...
topics = ['Super Bowl 50', 'Warsaw', 'Normans', 'Nicola Tesla', 'Computational complexity theory', 'Teacher', 'Martin Luther',
    ...
    'Force']  # List of topics. Edit this list if you want to add or remove any specific topic. Please be specific(Full Title) while adding the topic.
